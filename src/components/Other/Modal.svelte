	...
	<div class="modal-backdrop">
		<div class="modal show d-block" tabindex="-1">
			<div class="modal-dialog">
				<div class:d-none={$_modal.params.hidden} class="modal-content border-0">
					<div class:d-none={$_modal.params.hideHeader} class="modal-header">
						<div class="d-flex justify-content-between w-100 align-items-center">
							<div class="modal-title fs-5">{$_modal.params.title || 'Modal Title'}</div>
							<div>
								{#if $_modal.params.titleBadge}
									<span class={`me-2 badge bg-${$_modal.params.titleBadge.color || 'secondary'}`}>
					...
					<div class="modal-body">
						...
						{#if $_modal.Component}
							<svelte:component this={$_modal.Component} props={$_modal.params?.componentProps} />
						{/if}
					</div>
